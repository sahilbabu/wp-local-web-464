...
function optionsframework_menu_settings() {
	...
	$menu = array(
		'page_title' => __( 'Tribbiani Theme Options', 'optionsframework'),
		'menu_title' => __('Tribbiani Settings', 'optionsframework'),
		'capability' => 'edit_theme_options',
		'menu_slug' => 'tribbiani-options',
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'Tribbiani Settings', 'options_framework_theme' ),
			'href' => admin_url( 'themes.php?page=tribbiani-options' )
		));
}
