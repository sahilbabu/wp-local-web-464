...
require_once dirname( __FILE__ ).'/widget/recent_list.php';
require_once dirname( __FILE__ ).'/widget/recent-large.php';
require_once dirname( __FILE__ ).'/widget/recent-large-overlay.php';
require_once dirname( __FILE__ ).'/widget/carousel.php';
require_once dirname( __FILE__ ).'/widget/subscribe_box.php';
require_once dirname( __FILE__ ).'/widget/social_icons.php';
require_once dirname( __FILE__ ).'/widget/video-widget.php';
require_once dirname( __FILE__ ).'/widget/about-us.php';
require_once dirname( __FILE__ ).'/widget/recent_main_list_white.php';

//Shortcode need active
require_once dirname(__FILE__) . '/shortcode/shortcode.php';
//Metabox  need active
require_once dirname(__FILE__) . '/addon/meta-box/meta-box.php';
//post like
require_once dirname(__FILE__) . '/addon/post-like.php';
//page builder  need active
require_once dirname(__FILE__) . '/addon/aqua-page-builder-master/aqua-page-builder.php';
//sidebar
