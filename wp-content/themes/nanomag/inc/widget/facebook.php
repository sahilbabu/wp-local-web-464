...
/*-----------------------------------------------------------------------------------*/
	...
	function __construct(){	
		$widget_ops = array( 'classname' => 'fblikebox_widget', 'description' => esc_attr__( 'Facebook widget.', 'jelly_text_main') );
		parent::__construct('jellywp_fb_likebox_widget', esc_attr__('jellywp: Facebook widget', 'jelly_text_main'), $widget_ops);
...
/*-----------------------------------------------------------------------------------*/
	...
	function form($instance){
		?>
		<?php
			$defaults = array( 'title'=> esc_attr__( '', 'jelly_text_main'), 'page_url' => 'https://www.facebook.com/themeforest', 'lang' => 'en_US', 'theme_color' => 'light', 'show_faces' => 'on', 'stream' => null, 'header' => 'on' );
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('page_url')); ?>"><?php esc_attr_e( 'Facebook Page URL:', 'jelly_text_main'  ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('lang')); ?>"><?php esc_attr_e( 'Facebook Language:', 'jelly_text_main'  ); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_faces')); ?>"><?php esc_attr_e( 'Show Faces', 'jelly_text_main'  ); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('stream')); ?>"><?php esc_attr_e( 'Show Stream', 'jelly_text_main'  ); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('header')); ?>"><?php esc_attr_e( 'Show Header', 'jelly_text_main'  ); ?></label>
		</p>

		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'theme_color' )); ?>"><?php esc_attr_e('Theme Color:', 'jelly_text_main'); ?></label> 
