...
/*-----------------------------------------------------------------------------------*/
    ...
    function __construct() {
        $widget_ops = array(
            ...
            'description' => esc_attr__('Display post list on menu or widget.', 'jelly_text_main')
        );
        parent::__construct('recent-post-large-style', esc_attr__('jellywp: Recent post large', 'jelly_text_main'), $widget_ops);
    }
