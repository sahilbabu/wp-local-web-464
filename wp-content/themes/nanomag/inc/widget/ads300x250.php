...
/*-----------------------------------------------------------------------------------*/
	...
	function jellywp_ads300x250_widget(){
		$widget_ops = array( 'classname' => 'jellywp_ads300x250_widget', 'description' => esc_attr__( 'Ads 300x250' , 'jelly_text_main') );
		parent::__construct('jellywp_ads300x250_widget', esc_attr__('jellywp: Ads 300x250', 'jelly_text_main'), $widget_ops);
	}
