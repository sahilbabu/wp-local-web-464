...
/*-----------------------------------------------------------------------------------*/
	...
	function  __construct() {
		$widget_ops = array( 'classname' => 'post_list_widget', 'description' => esc_attr__( 'Display a list of popular posts', 'jelly_text_main' ) );
		parent::__construct('popular_widget', esc_attr__('jellywp: popular post', 'jelly_text_main'), $widget_ops);
	}
...
/*-----------------------------------------------------------------------------------*/
	...
	{
		$defaults = array('title' => esc_attr__( 'Popular Posts', 'jelly_text_main' ) , 'num_posts' => 4, 'show_comments' => 'on');
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('num_posts')); ?>"><?php esc_attr_e( 'Number of posts:', 'jelly_text_main' ); ?></label>
