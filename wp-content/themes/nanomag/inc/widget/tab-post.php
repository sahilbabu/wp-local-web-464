...
/*-----------------------------------------------------------------------------------*/
    ...
    function __construct() {
        $widget_ops = array(
            'classname' => 'clearfix',
            'description' => esc_attr__('Display post in tab by select category', 'jelly_text_main')
        );
        parent::__construct('tab-post-widget', esc_attr__('jellywp: Tab post Widget', 'jelly_text_main'), $widget_ops);
    }
        ...
        <div  id="tabs" class="widget_container">
		 <!--tabs-nav -->
            ...
            if (!empty($cats)) {
				...
				esc_attr_e('No post' ,'jelly_text_main');
				echo '</a></li>';
			}
            ?>
         ...
         <div class="tab-container">
            ...
            if (!empty($cats)) {
                foreach ($cats as $cat_id) {
                    ...
                    <div id="category_<?php echo $cat_id; ?>" class="tab-content tab_post_category">
...
/*-----------------------------------------------------------------------------------*/
 ...
 <p><label for="<?php echo esc_attr($this->get_field_id('number_offset')); ?>"><?php esc_attr_e('Offset posts:', 'jelly_text_main'); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('cats')); ?>"><?php esc_attr_e('Select categories to include in the recent posts list:', 'jelly_text_main'); ?> 
