...
/*-----------------------------------------------------------------------------------*/
    ...
    function __construct() {
        $widget_ops = array(
            ...
            'description' => esc_attr__('Tab widget: Popular, latest and comment.', 'jelly_text_main')
        );
        parent::__construct('triple-posts', esc_attr__('jellywp: Tab widget', 'jelly_text_main'), $widget_ops);
    }
...
/*-----------------------------------------------------------------------------------*/
    ...
    function widget($args, $instance) {
        ...
        <div  id="tabs" class="widget_container">    
            ...
            <!--tabs-nav -->
            <ul class="tabs">
                <li class="active"><a class="title" href="#tab1"><?php esc_attr_e('Popular', 'jelly_text_main'); ?></a></li>
                <li><a class="title" href="#tab2"><?php _e('Recent', 'jelly_text_main'); ?></a></li>
               <?php if ($show_comment_tab == true) { ?> <li><a class="title" href="#tab3"><?php esc_attr_e('Comments', 'jelly_text_main'); ?></a></li><?php }?>
            </ul>
            <!-- end tabs-nav -->
...
<?php echo jelly_post_meta(get_the_ID()); ?>
 ...
 <p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_comment_tab')); ?>"><?php esc_attr_e( 'Show comment tab', 'jelly_text_main'); ?></label>
		</p>
