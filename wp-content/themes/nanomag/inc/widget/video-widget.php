...
/*-----------------------------------------------------------------------------------*/
	...
	function __construct(){	
		$widget_ops = array( 'classname' => 'video_embed_widget', 'description' => esc_attr__( 'paste video url for display (youtube, vimeo).', 'jelly_text_main') );
		parent::__construct('jellywp_video_widget', esc_attr__('jellywp: Video embed widget', 'jelly_text_main'), $widget_ops);
...
/*-----------------------------------------------------------------------------------*/
	...
	function form($instance){
		?>
		<?php
			$defaults = array( 'title'=> esc_attr__( '', 'jelly_text_main'), 'video_url' => '', 'video_height' => 200);
        ...
        <p>
			<label for="<?php echo esc_attr($this->get_field_id('video_url')); ?>"><?php esc_attr_e( 'Video URL( Vimeo/Youtube ) :', 'jelly_text_main'  ); ?></label>
        ...
        <p>
			<label for="<?php echo esc_attr($this->get_field_id('video_height')); ?>"><?php esc_attr_e( 'Video Height :', 'jelly_text_main'  ); ?></label>
