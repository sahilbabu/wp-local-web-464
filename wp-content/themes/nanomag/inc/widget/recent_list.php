...
/*-----------------------------------------------------------------------------------*/
	...
	function __construct() {
    	$widget_ops = array(
			...
			'description' => esc_attr__('Display a list of recent post.', 'jelly_text_main')
		);
    	parent::__construct('rec-recent-posts', esc_attr__('jellywp: Recently Posts', 'jelly_text_main'), $widget_ops);
	}
