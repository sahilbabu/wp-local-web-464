...
/*-----------------------------------------------------------------------------------*/
	...
	function jellywp_recent_comments_widget() {
		$widget_ops = array( 'classname' => 'post_list_widget comment_widget', 'description' => esc_attr__('Displays recent comments.', 'jelly_text_main') );
		$this->WP_Widget( 'jellywp_recent_comments_widget', esc_attr__('jellywp: Recent Comments', 'jelly_text_main'), $widget_ops);
	}
...
/*-----------------------------------------------------------------------------------*/
	...
	?>
		<p><label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_attr_e('Title:', 'jellywp'); ?></label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id( 'entries_display' )); ?>"><?php esc_attr_e('How many entries to display?', 'jellywp'); ?></label>
