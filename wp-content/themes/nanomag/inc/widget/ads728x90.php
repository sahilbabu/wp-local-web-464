...
/*-----------------------------------------------------------------------------------*/
	...
	function jellywp_ads728x90_widget(){
		$widget_ops = array( 'classname' => 'jellywp_ads728x90_widget', 'description' => esc_attr__( 'Ads 728x90' , 'jelly_text_main') );
		parent::__construct('jellywp_ads728x90_widget', esc_attr__('jellywp: Ads 728x90', 'jelly_text_main'), $widget_ops);
	}
