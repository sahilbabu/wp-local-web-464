...
/*-----------------------------------------------------------------------------------*/
    ...
    function __construct() {
        $widget_ops = array(
            ...
            'description' => esc_attr__('Display main post with list of recent post.', 'jelly_text_main')
        );
        parent::__construct('home-main-post-style', esc_attr__('jellywp: main post images black background', 'jelly_text_main'), $widget_ops);
    }
