...
/*-----------------------------------------------------------------------------------*/
	...
	function __construct() {
		$widget_ops = array('classname' => 'ht_flickr_widget', 'description' => esc_attr__( 'Images from Flickr.', 'jelly_text_main') );
		parent::__construct('flickr_widget', esc_attr__('jellywp: Flickr', 'jelly_text_main'), $widget_ops);
...
/*-----------------------------------------------------------------------------------*/
	...
	<?php esc_attr_e('Title:', 'jelly_text_main'); ?></label>
	...
	<?php esc_attr_e('Flickr ID', 'jelly_text_main'); ?></label>
	...
	<?php esc_attr_e('Number:', 'jelly_text_main'); ?></label>
