...
class home_post_right_list extends AQ_Block {
	...
	function __construct() {
		$block_options = array(
      'name' => esc_attr__('Home post with right post', 'jelly_text_main'),
			'size' => 'span12',
		);
   ...
   <p>
	...
	function block($instance) {
        ...
        $i = 0;?>
        <div class="widget main_post_style main_right_post_style_list clearfix <?php echo esc_attr($instance['css_class_builder']);?>">
