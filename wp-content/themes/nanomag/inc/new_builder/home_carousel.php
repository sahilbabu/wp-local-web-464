<?php
class home_carousel_post extends AQ_Block {
	
	//set and create block
	function __construct() {
		$block_options = array(
		    'name' => esc_attr__('Home carousel post', 'jelly_text_main'),
			'size' => 'span12',
		);
		
		//create the block
		parent::__construct('home_carousel_post', $block_options);
	}
	
	
	//create form
	function form($instance) {
        $titles = isset($instance['titles']) ? esc_attr($instance['titles']) : 'Home carousel post';
