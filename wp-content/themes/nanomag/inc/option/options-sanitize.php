...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_attr__('No Repeat', 'options_framework_theme'),
		'repeat-x'  => esc_attr__('Repeat Horizontally', 'options_framework_theme'),
		'repeat-y'  => esc_attr__('Repeat Vertically', 'options_framework_theme'),
		'repeat'    => esc_attr__('Repeat All', 'options_framework_theme'),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_attr__('Top Left', 'options_framework_theme'),
		'top center'    => esc_attr__('Top Center', 'options_framework_theme'),
		'top right'     => esc_attr__('Top Right', 'options_framework_theme'),
		'center left'   => esc_attr__('Middle Left', 'options_framework_theme'),
		'center center' => esc_attr__('Middle Center', 'options_framework_theme'),
		'center right'  => esc_attr__('Middle Right', 'options_framework_theme'),
		'bottom left'   => esc_attr__('Bottom Left', 'options_framework_theme'),
		'bottom center' => esc_attr__('Bottom Center', 'options_framework_theme'),
		'bottom right'  => esc_attr__('Bottom Right', 'options_framework_theme')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_attr__('Scroll Normally', 'options_framework_theme'),
		'fixed'  => esc_attr__('Fixed in Place', 'options_framework_theme')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_attr__('Normal', 'options_framework_theme'),
		'italic'      => esc_attr__('Italic', 'options_framework_theme'),
		'bold'        => esc_attr__('Bold', 'options_framework_theme'),
		'bold italic' => esc_attr__('Bold Italic', 'options_framework_theme')
		);
