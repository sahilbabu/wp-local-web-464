		  ...
		  ?>
	       <div class="auth">
                            <div class="author-info">                                       
                               ...
                               <li><a href="mailto:<?php echo esc_attr(the_author_meta('email' , $user->ID)); ?>" target="_blank"><img alt="" src="<?php echo get_template_directory_uri(); ?>/img/icons/email.png"></a></li>
                               <?php }?>
