...
<div class="auth author_post_list">
                            <div class="author-info">                                       
                               ...
                               <li><a href="mailto:<?php echo esc_url(get_the_author_meta('email',$post_list_auth->ID)); ?>" target="_blank"><img alt="" src="<?php echo get_template_directory_uri(); ?>/img/icons/email.png"></a></li>
                               <?php }?>
