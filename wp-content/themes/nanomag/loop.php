            ...
            <div class="eight columns content_display_col1 cat_post_loop_display" id="content">
                <div class="widget_container content_page">
                    ...
                    if (is_search()) {
                        ...
                        esc_attr_e('Search for: ', 'jelly_text_main');
                        the_search_query();
                        echo '</h3>';
                    } else if (is_category()) {
                        echo '<h3 class="categories-title title">';
                        esc_attr_e('Category: ', 'jelly_text_main');
                        single_cat_title('', true);
                        echo '</h3>';
                    } else if (is_author()) {
                        echo '<h3 class="categories-title title">';
                        esc_attr_e('Author: ', 'jelly_text_main');
                        the_author();
                        echo '</h3>';
                    } else if (is_tag()) {
                        echo '<h3 class="categories-title title">';
                        esc_attr_e('Tag: ', 'jelly_text_main');
                        the_tags('');
                        echo '</h3>';
                    } else if (is_archive()) {
                        echo '<h3 class="categories-title title">';
                        esc_attr_e('Archives post', 'jelly_text_main');
                        echo '</h3>';
                    }
                    ?>
                                    ...
                                    ?>">
                                        <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                                            ...
                                            <div class="meta_holder">
                                                <?php
                                                if (of_get_option('disable_post_category') != 1) {
                                                    if ($categories) {
