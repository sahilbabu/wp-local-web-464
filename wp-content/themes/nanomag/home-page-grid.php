<?php
/*
  Template Name: Home page grid post
 */
?>
<?php get_header(); ?>
<?php 
...
<div class="content_wraper three_columns_container">
   <!-- Start content -->
     <div class="eight columns content_display_col1 content_masonry_grid_home" id="content">
             <?php 
...
?> 
			  <div class="post_list_medium_widget grid_more_homepage" id="content_masonry_grid">
                    <?php
