    ...
    <xsl:template match="/">
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
                ...
                <div id="footer">
                    This plugin is (c) 2014 <a href="http://profiles.wordpress.org/users/OddOneOut/">Khang Minh</a> Modified by <a href="https://github.com/sahilbabu">Mudassar Ali Sahil</a> and is licensed under GPLv3.
                </div>
            </body>
        </html>
    </xsl:template>
